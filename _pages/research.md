...
<style>
  ...
  .paper-id{font-size:.9em; padding:0 6px; color:#777; margin:0 0 1em 0;}
  .paper-id a{color:#777; text-decoration:none;}
  .abs-btn{font-family:Helvetica,sans-serif; font-weight:300; font-size:.9em; padding:2px 6px; margin:.35em 0 0 0; background:none; border:none; color:#555; cursor:pointer; font-weight:500;}
  .abs-btn:hover{text-decoration:underline;}
  .abstract{font-family:Helvetica,sans-serif; font-weight:300; display:none; margin:.5em 0 0 1rem; font-size:.9em;}
</style>


<div class="paper">
  <p class="paper-title">
    <a style="color:rgb(11,73,132);" href=""> <strong> Delivering Higher Pay? The Impacts of a Task-Level Pay Standard in the Gig Economy </strong> </a> <br>
  </p>
  ...
  <p class="paper-meta">
    ...
    <span style="font-size:.9em; color:#777;">Coverage:</span> <a style="font-size:.9em; color:black;" href="https://finance.yahoo.com/news/seattles-delivery-minimum-wage-failed-120039601.html">Yahoo Finance</a>, <a style="font-size:.9em; color:black;" href="">NBER Digest</a>
  </p>
