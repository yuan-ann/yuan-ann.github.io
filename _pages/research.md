...
<p style="color:rgb(113,128,150); font-size:1.2em; line-height:300%;"> Working Papers </p>

<style>
  .paper{margin:1.2rem 0 2rem;}
  .paper-title{margin:0 0 .2em 0; line-height:105%;}
...
<div class="paper">
  ...
  <p class="paper-id">
    How do <i>per-task</i> minimum pay standards impact earnings and employment in labor markets with <i>no distinction</i> between employed "insiders" and unemployed "outsiders"?
  </p>
